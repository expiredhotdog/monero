...
complete -c monerod -l wildnet -d "Run on wildnet. The wallet must be launched with --wildnet flag."
...
complete -c monerod -l p2p-bind-port -r -d "Port for p2p network protocol (IPv4). Default: 18080, 28080 if 'testnet', 38080 if 'stagenet', 48080 if 'wildnet'"
complete -c monerod -l p2p-bind-port-ipv6 -d "Port for p2p network protocol (IPv6). Default: 18080, 28080 if 'testnet', 38080 if 'stagenet', 48080 if 'wildnet'"
